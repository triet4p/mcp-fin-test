...
#   filename:  <stdin>
#   timestamp: 2025-09-15T13:43:24+00:00
...
class AggregatedScoreInfo(BaseModel):
    ...
    """
    Điểm số quyết định thô (trước khi có MetaRule).
    """
    raw_risk_score: float = Field(..., title='Raw Risk Score')
    """
    Điểm số rủi ro thô (trước khi có MetaRule).
    """
    raw_opportunity_score: float = Field(..., title='Raw Opportunity Score')
    """
    Điểm số cơ hội thô (trước khi có MetaRule).
    """
